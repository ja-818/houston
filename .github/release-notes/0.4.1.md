...
- **Skills everywhere.** Skills now have a real UI. The empty chat shows up to 3 featured Skills, the picker has tabs by category and a Featured row, and starting a Skill takes over the composer with a clean labeled form. The conversation shows your Skill as a card with all the values you filled in.
...
- **Mobile companion (beta).** Tap "Connect phone" in the sidebar, scan the QR code with the Houston iOS app, and you can manage Houston from your phone. Your Mac stays the source of truth, the phone is a window into it. Skill cards render on the phone too.
