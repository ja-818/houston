...
// ─── Legal acceptance ────────────────────────────────────────────────
//
// Placed below the raw get/set helpers (and far away from TIMEZONE_KEY)
// so parallel edits to the locale preference in `preferences.rs` don't
// collide with this block at merge time.
